...
if __name__ == "__main__" :
    ...
    resultantAge = Button(gui, text = "Resultant Age", fg = "White", bg = "purple", command = calculateAge)
 
    # Create a Clear All Button and attached to clearAll function
    clearAllEntry = Button(gui, text = "Clear All", fg = "White", bg = "purple", command = clearAll)
